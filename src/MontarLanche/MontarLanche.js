...
import './MontarLanche.scss';
import _ from 'underscore';

class MontarLanche extends Component {
  ...
  _valorLancheSelecionado = () => {
    ...
    let arrayIngredientesTotais = this.state.ingredientes;
  ...
  render() {
    return (
      !this.state.telaFim ?
      <div className="MontarLanche">
      <div className="MontarLanche__card">
        <div className="MontarLanche__card__title-lanche">
          Monte seu Lanche
        </div>
      </div>
        <div className="MontarLanche__card-ingredientes">
          <div className="MontarLanche__lista-ingredientes__titulo">
            Conteudo do Lanche:
          </div>
          <div className="MontarLanche__lista-ingredientes">
          {_.map(this.state.ingredientesLanche, (itemLanche, index) =>
          <div className="MontarLanche__lista-ingredientes__item">
        <div className="MontarLanche__lista-ingredientes__item__nome-produto">
          {itemLanche}
        </div>
        <div className="MontarLanche__lista-ingredientes__item__remover-produto" onClick={e => this._removeItemLanche(itemLanche, index)}>
          X
        </div>
        </div>
      )}
          </div>
        <div className="MontarLanche__preco-confirmar">
        <div className="MontarLanche__preco-lanche">
          R$ {this.state.valorAtualLanche}
        </div>
        {this.state.valorAtualLanche > 0 &&
          <div className="MontarLanche__finalizar-compra">
            <div className="MontarLanche__finalizar-compra__bnt-finalizar" onClick={e => this._redirectTelaFim()}>
              Concluir
            </div>
          </div>
        }
        ...
        <div className="MontarLanche__card-adicionar">
          <div className="MontarLanche__card-adicionar__title">
          O que deseja acrescentar?
          </div>
        <div className="MontarLanche__menu-adicionar">
            {_.map(this.state.ingredientes, ingrediente =>
              <li className="MontarLanche__menu-adicionar__item" onClick={e => this._adicionaIngredienteLanche(ingrediente.nomeProduto)}>
      ...
      :
      <div className="MontarLanche__telaFim">
